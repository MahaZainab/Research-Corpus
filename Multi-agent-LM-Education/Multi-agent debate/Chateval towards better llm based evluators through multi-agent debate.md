...
Along with simulataneous-talk an additional LLM work as a summarizer. At the end of each iteration of the debate, we prompt this extra LLM to summarize the message