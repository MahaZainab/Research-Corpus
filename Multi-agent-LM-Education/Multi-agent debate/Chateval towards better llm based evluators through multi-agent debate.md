...
#### Benchmarks:
1. Open-ended question answer: for each question, they direct three annotators to evaluate the replies given by vicuna 13B and chatgpt model through the rules and then
