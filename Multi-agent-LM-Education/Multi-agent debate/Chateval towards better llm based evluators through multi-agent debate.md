...
2. Kappa, which gauge the agreement between results from models and human annotators while taking into account the possiblity of agreement between results by chance.
