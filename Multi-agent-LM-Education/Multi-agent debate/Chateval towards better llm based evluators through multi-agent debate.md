...
Main contribution of this research is proposing multi-agent based framework called chateval that aligns better with human preferences compared with single agent based