...
All agents share a common prompt template, they substitute the role description slot with diverse role prompt. Which will specify distinct personalities