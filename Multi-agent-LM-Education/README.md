...
They have break down it in multiple steps. First, they generate the language specific data from the code snippet.Then, generated data is used as a seed data for language specific agents. Multiple language specific agents discuss and collaborate a   